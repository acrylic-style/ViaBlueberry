package net.blueberrymcmods.viablueberry.common.config;
...
public class VBConfig extends Config {
    ...
    public VBConfig(File configFile) {
        super(configFile);
        reloadConfig();
    }
    ...
    public URL getDefaultConfigURL() {
        return getClass().getClassLoader().getResource("assets/viablueberry/config.yml");
    }
