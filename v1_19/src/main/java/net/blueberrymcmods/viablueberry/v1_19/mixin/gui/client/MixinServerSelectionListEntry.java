...
public class MixinServerSelectionListEntry {
    ...
    private void redirectPingIcon(int i, ResourceLocation location) {
        if (location.equals(GuiComponent.GUI_ICONS_LOCATION) && ((ViaServerData) this.serverData).isViaTranslating()) {
